...
Route::get('admin/customer/create', [CustomerControllerForAdmin::class,'create'])
    ->name('admin_customer_create');

Route::post('admin/customer/store', [CustomerControllerForAdmin::class,'store'])
    ->name('admin_customer_store');

Route::get('admin/customer/edit/{id}', [CustomerControllerForAdmin::class, 'edit'])
